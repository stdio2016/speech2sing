// modified by stdio2016 on 2018/8/29
// add closure
function audioRecorderPolyfill(context) {
 ...
 * @class
 */
function MediaRecorder (stream, sharedNode) {
  /**
...
MediaRecorder.prototype = {
  ...
  start: function start (timeslice) {
    if (this.state === 'inactive') {
      ...
      var input = this.input || context.createMediaStreamSource(this.stream)
      var processor = context.createScriptProcessor(2048, 1, 1)
      // modified by stdio2016
      // for cleanup
      this.input = input
  ...
  stop: function stop () {
    if (this.state !== 'inactive') {
      ...
      // modified by stdio2016
      // cleanup
      // XXX: Safari doesn't support disconnect() with param
